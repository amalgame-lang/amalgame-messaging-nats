...
run_test "PublishWithReply (v0.2)" "[PASS] PublishWithReply round-trip"
run_test "SubscribeQueue (v0.2)"   "[PASS] SubscribeQueue receives msg"
run_test "Request timeout (v0.2)"  "[PASS] Request timeout returns empty"
